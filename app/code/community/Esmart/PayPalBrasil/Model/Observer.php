...
class Esmart_PayPalBrasil_Model_Observer
{
     ...
     * @return bool
     */
    public function redirectFailure(Varien_Event_Observer $observer)
    {
        $id = $observer->getEvent()->getOrderIds();
        ...
        Mage::getSingleton('checkout/session')->setLastQuoteId($id);
        Mage::getSingleton('checkout/session')->setLastOrderId($id);
